/*Crie um programa que peça ao usuário um valor inicial e um valor final para gerar tabuadas que vão do valor inicial até o valor final*/

let entrada = require('prompt-sync')();
let vInicial = entrada('Digite um número para começar a tabuada: ');
